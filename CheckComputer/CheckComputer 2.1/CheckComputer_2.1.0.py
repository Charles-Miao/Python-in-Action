...
class MainUI:
    def __init__(self, activation, officesan, connection, install, activation_result, officescan_result):
...
if __name__ == "__main__":
    ...
    #show_UI
    UI = MainUI(os_activation.is_activated(),check_officescan.virus_pattern_identical,check_officescan.network_connection,check_officescan.install_officescan,check_activation_result,check_officescan_result)
    UI.showUI()
