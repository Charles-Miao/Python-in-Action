...
if __name__=="__main__":
	...
	search_pattern = r"Failing test due to.*?Exception\s.*"
	...
	for i in range(len(source_dirs)):
		p.apply_async(filt_logs, args=(source_folder+"\\"+source_dirs[i],destination_folder,search_pattern))
	p.close()
	p.join()
